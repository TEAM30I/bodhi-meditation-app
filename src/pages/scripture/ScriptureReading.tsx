...
const ScriptureReading = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
      {activeTab !== 'calendar' && activeTab !== 'bookmark' ? (
        <>
          {/* Header */}
          ...
          {/* Categories */}
          <div className="px-6 py-3 flex space-x-2 overflow-x-auto bg-white border-b">
          ...
          {activeTab === 'reading' ? (
            <div className="px-6 py-4 bg-white" style={{ fontSize: `${fontSize}px` }}>
