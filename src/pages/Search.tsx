...
import { ArrowLeft, Navigation, Search as SearchIcon } from "lucide-react";
    ...
    <div className="bg-white flex flex-row justify-center w-full min-h-screen pb-[80px]">
      <div className="bg-white overflow-hidden w-[390px] relative">
        ...
        <div className="w-[392px] h-[73px]">
          ...
          {/* Tabs */}
          <Tabs defaultValue="temple" className="w-[338px] h-11 mx-auto">
        ...
        >
          <Navigation className="w-[21px] h-[21px] absolute left-[9px]" />내
          주변에서 검색
        </Button>
